...
export const listarContatos =()=>{
    return async dispatch=>{
        try{
            ...
            dispatch({type: LISTA_CONTATOS, contatos:resultadoBD.rows._array});
        }
        catch(err){
            console.log(err);
            throw err;
...
export const addContato = (nomeContato, numeroContato, imagem, latContato, lngContato, dataContato) =>{
    return async dispatch=>{
        ...
        try{
            ...
            ,numeroContato: numeroContato, imagem:novoPath, latContato: latContato, 
            lngContato: lngContato, dataContato: dataContato}})
        }
        catch(err){
            console.log(err);
            throw err;
